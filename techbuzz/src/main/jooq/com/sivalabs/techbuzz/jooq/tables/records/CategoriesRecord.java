...
public class CategoriesRecord extends UpdatableRecordImpl<CategoriesRecord> implements Record8<Long, String, String, String, String, BigDecimal, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row8<Long, String, String, String, String, BigDecimal, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public CategoriesRecord value6(BigDecimal value) {
    ...
    @Override
    public CategoriesRecord values(Long value1, String value2, String value3, String value4, String value5, BigDecimal value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CategoriesRecord(Long id, String name, String slug, String description, String image, BigDecimal displayOrder, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Categories.CATEGORIES);
     ...
     * Create a detached, initialised CategoriesRecord
     */
    public CategoriesRecord(JooqCategories value) {
        super(Categories.CATEGORIES);
